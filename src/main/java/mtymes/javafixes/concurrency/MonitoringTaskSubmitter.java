...
public class MonitoringTaskSubmitter {
    ...
    /**
     * Schedules a {@link mtymes.javafixes.concurrency.Task Task} for immediate execution
     * It might be executed later though if the {@link ScheduledExecutorService} has no available threads
     * or more tasks are queued for execution before this task.
     *
     * @param task {@link mtymes.javafixes.concurrency.Task Task} to be executed
     * @return {@link Future} referring to the state of submitted {@link mtymes.javafixes.concurrency.Task Task}
     */
    ...
    /**
     * Schedules a {@link mtymes.javafixes.concurrency.Task Task} for delayed execution
     * The delay is defined using the {@code delay} and {@code unit} parameters.
     * It might be executed later though if the {@link ScheduledExecutorService} has no available threads
     * or more tasks are queued for execution before this task.
     *
