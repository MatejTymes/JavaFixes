 ...
 * <p>
 * <p>The {@code ShutdownAwareTask} interface is similar to {@link Task},
 * in that both are designed for classes whose instances are potentially executed by another thread.
 * A {@code ShutdownAwareTask} however has an input argument {@link ShutdownInfo} which can be asked
