 ...
 * <p>
 * <p>The {@code ShutdownAwareCallable} interface is similar to {@link Callable},
 * in that both are designed for classes whose instances are potentially executed by another thread.
 * A {@code ShutdownAwareCallable} however has an input argument {@link ShutdownInfo} which can be asked
