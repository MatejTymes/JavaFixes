...
public interface ChangingValue<T> extends Value<T> {
    ...
    /**
     * Generates a value using the current {@code ChangingValue}'s wrapped {@code FailableValue}
     *
     * @param valueMapper function that is applied to currently wrapped {@code FailableValue}
    ...
    /**
     * Executes {@code valueHandler} function for currently wrapped {@code FailableValue}
     *
     * @param valueHandler function that is executed for currently wrapped {@code FailableValue}
