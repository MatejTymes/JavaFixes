...
/**
 * {@link Either} can wrap value of one of 2 types defined as {@link Left} or {@link Right}.
 * This is an unbiased implementation where both left and right side have the same methods and neither one is preferred.
 *
 * @param <L> the {@link Left} {@link Either} type
 * @param <R> the {@link Right} {@link Either} type
 * @author mtymes
 */
public abstract class Either<L, R> extends DataObject implements Value<Object> {
    ...
    /**
     * Generates {@link Either} of type {@link Right} wrapping the provided value
     *
     * @param value value to wrap
     * @param <L>   generic type of left side
     * @param <R>   generic type of right side
     * @return {@link Right} {@link Either} wrapping provided value
     */
    ...
    /**
     * Generates {@link Either} of type {@link Left} wrapping the provided value
     *
     * @param value value to wrap
     * @param <L>   generic type of left side
     * @param <R>   generic type of right side
     * @return {@link Left} {@link Either} wrapping provided value
     */
    ...
    /**
     * Returns true if value is wrapped into a {@link Left} {@link Either}
     *
     * @return true if is {@link Left} {@link Either}
     */
    public abstract boolean isLeft();

    /**
     * Returns true if value is wrapped into a {@link Right} {@link Either}
     *
     * @return true if is {@link Right} {@link Either}
     */
    public abstract boolean isRight();

    /**
     * Returns wrapped value in case the {@link Either} is of type {@link Left}.
     * Throws a {@link NoSuchElementException} in case the {@link Either} is of type {@link Right}.
     *
     * @return value in case the {@link Either} is of type {@link Left}
     * @throws NoSuchElementException in case the {@link Either} is of type {@link Right}
     */
    public abstract L getLeft() throws NoSuchElementException;

    /**
     * Returns wrapped value in case the {@link Either} is of type {@link Right}.
     * Throws a {@link NoSuchElementException} in case the {@link Either} is of type {@link Left}.
     *
     * @return value in case the {@link Either} is of type {@link Right}
     * @throws NoSuchElementException in case the {@link Either} is of type {@link Left}
     */
    public abstract R getRight() throws NoSuchElementException;

    /**
     * Returns wrapped value in case the {@link Either} is of type {@link Left}.
     * Throws {@link Exception} provided via {@code exceptionSupplier} if value is defined as {@link Right} {@link Either}.
     *
     * @param exceptionSupplier that should provide {@link Exception} in case of {@link Right} {@link Either}
     * @param <T>               type of {@link Exception} that will be provided by exceptionSupplier
     * @return value in case the {@link Either} is of type {@link Left}
     * @throws T {@link Exception} provided via {@code exceptionSupplier} if value is defined as {@link Right} {@link Either}.
     */
    public abstract <T extends Throwable> L getLeftOrThrow(Supplier<? extends T> exceptionSupplier) throws T;

    /**
     * Returns wrapped value in case the {@link Either} is of type {@link Right}.
     * Throws {@link Exception} provided via {@code exceptionSupplier} if value is defined as {@link Left} {@link Either}.
     *
     * @param exceptionSupplier that should provide {@link Exception} in case of {@link Left} {@link Either}
     * @param <T>               type of {@link Exception} that will be provided by exceptionSupplier
     * @return value in case the {@link Either} is of type {@link Right}
     * @throws T {@link Exception} provided via {@code exceptionSupplier} if value is defined as {@link Left} {@link Either}.
     */
    public abstract <T extends Throwable> R getRightOrThrow(Supplier<? extends T> exceptionSupplier) throws T;

    /**
     * Applies provided {@code leftValueMapper} to transform wrapped {@code value} if value is defined as {@link Left} {@link Either}.
     * Applies provided {@code rightValueMapper} to transform wrapped {@code value} if value is defined as {@link Right} {@link Either}.
     *
     * @param leftValueMapper  function that is applied {@link Left} {@link Either} {@code value}
     * @param rightValueMapper function that is applied {@link Right} {@link Either} {@code value}
     * @param <L2>             new type of {@link Left} {@link Either} {@code value}
     * @param <R2>             new type of {@link Right} {@link Either} {@code value}
    ...
    /**
     * Applies provided {@code leftValueMapper} to transform wrapped {@code value} if value is defined as {@link Left} {@link Either}.
     * The {@code leftValueMapper} is ignored if value is defined as {@link Right} {@link Either}.
     *
     * @param leftValueMapper function that is applied {@link Left} {@link Either} {@code value}
     * @param <L2>            new type of {@link Left} {@link Either} {@code value}
     * @return modified {@link Either}
    ...
    /**
     * Applies provided {@code rightValueMapper} to transform wrapped {@code value} if value is defined as {@link Right} {@link Either}.
     * The {@code rightValueMapper} is ignored if value is defined as {@link Left} {@link Either}.
     *
     * @param rightValueMapper function that is applied {@link Right} {@link Either} {@code value}
     * @param <R2>             new type of {@link Right} {@link Either} {@code value}
     * @return modified {@link Either}
     ...
     *
     * @param foldLeft  function to map {@link Left} value into output value
     * @param foldRight function to map {@link Right} value into output value
    ...
    /**
     * Executes provided {@code leftValueHandler} if value is defined as {@link Left} {@link Either}.
     * The {@code action} is ignored if value is defined as {@link Right} {@link Either}.
     *
     * @param leftValueHandler action that is executed for {@link Left} {@link Either}
    ...
    /**
     * Executes provided {@code rightValueHandler} if value is defined as {@link Right} {@link Either}.
     * The {@code action} is ignored if value is defined as {@link Left} {@link Either}.
     *
     * @param rightValueHandler action that is executed for {@link Right} {@link Either}
    ...
    /**
     * Throws {@link Exception} provided via {@code exceptionSupplier} if value is defined as {@link Left} {@link Either}.
     * The {@code exceptionSupplier} is ignored if value is defined as {@link Right} {@link Either}.
     *
     * @param exceptionSupplier that should provide {@link Exception} in case of {@link Left} {@link Either}
     * @param <T>               type of {@link Exception} that will be provided by exceptionSupplier
    ...
    /**
     * Throws {@link Exception} provided via {@code exceptionSupplier} if value is defined as {@link Right} {@link Either}.
     * The {@code exceptionSupplier} is ignored if value is defined as {@link Left} {@link Either}.
     *
     * @param exceptionSupplier that should provide {@link Exception} in case of {@link Right} {@link Either}
     * @param <T>               type of {@link Exception} that will be provided by exceptionSupplier
     * @return the same instance to allow method chaining
